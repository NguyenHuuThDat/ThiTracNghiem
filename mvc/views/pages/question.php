    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <button type="button" class="btn btn-hero btn-primary" data-bs-toggle="modal" data-bs-target="#modal-add-question" id="addquestionnew" data-role="cauhoi" data-action="create">
                    <i class="fa-regular fa-plus"></i> Thêm câu hỏi mới</button>
            </div>
        </div>
            ...
            <form action="#" method="POST" id="search-form" onsubmit="return false;">
                ...
                <div class="row mb-3">
                    <div class="input-group">
                        <input type="text" class="form-control form-control-alt" id="search-input" name="search-input" placeholder="Nội dung câu hỏi...">
                            ...
                            <div class="mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select class="js-select2 form-select data-chuong" id="chuong" name="chuong" data-tab="1" style="width: 100%;" data-placeholder="Choose one..">
                                        </select>
                                    </div>
                                    
                                    <div class="col-4">
                                        <label class="form-label">Độ khó</label>
                                        <select class="js-select2 form-select" id="dokho" name="dokho" style="width: 100%;" data-placeholder="Choose one..">
                                            <option></option>
                                            <option value="1">Cơ bản</option>
                                            <option value="2">Trung bình</option>
                                            <option value="3">Nâng cao</option>
