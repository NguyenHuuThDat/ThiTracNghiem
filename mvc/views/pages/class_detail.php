    ...
    <div class="row">
        ...
        <div class="col-8 d-flex align-items-center justify-content-end gap-3">
            <button type="button" class="btn btn-sm btn-primary" id="exportStudents">
                <i class="fa-solid fa-file me-1"></i>Xuất danh sách SV
            </button>
            ...
            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSetting" aria-controls="offcanvasSetting">
                <i class="fa fa-cog"></i>
            </button>
        </div>
    </div>
        ...
        <div class="modal-content">
            <div class="block block-rounded block-transparent bg-white mb-0">
                <ul class="nav nav-tabs nav-tabs-alt" role="tablist">
                    <li class="nav-item">
                        <button class="nav-link active" id="them-thu-cong-tab" data-bs-toggle="tab" data-bs-target="#them-thu-cong" role="tab" aria-controls="them-thu-cong" aria-selected="true">
                            Thêm thủ công
                        </button>
                    </li>

                    <li class="nav-item">
                        <button class="nav-link" id="ma-moi-tab" data-bs-toggle="tab" data-bs-target="#ma-moi" role="tab" aria-controls="ma-moi" aria-selected="false">
                            Tham gia bằng mã mời
                        </button>
                    </li>

                    <li class="nav-item">
                        <button class="nav-link" id="them-file-excel-tab" data-bs-toggle="tab" data-bs-target="#them-file-excel" role="tab" aria-controls="them-file-excel" aria-selected="false">
                ...
                <div class="block-content tab-content">
                    <div class="tab-pane fade fade-up show active" id="them-thu-cong" role="tabpanel" aria-labelledby="them-thu-cong-tab" tabindex="0">
                        <form id="addSvThuCong">
                            <div class="mb-3">
                                <label for="mssv" class="form-label">Mã sinh viên</label>
                                <input type="text" class="form-control" name="mssv" id="mssv" placeholder="Mã sinh viên" required>
                            </div>
                            ...
                            <div class="block-content block-content-full text-end">
                                ...
                                <button type="button" class="btn btn-sm btn-primary btn-add-sv-group">Thêm sinh viên</button>
                                <button type="button" class="btn btn-sm btn-primary btn-add-sv">Thêm sinh viên</button>
                            </div>
                        </form>
                    </div>

                    <div class="tab-pane fade fade-up" id="ma-moi" role="tabpanel" aria-labelledby="ma-moi-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade fade-up" id="them-file-excel" role="tabpanel" aria-labelledby="them-file-excel-tab" tabindex="0">
                        <form id="form-upload" method="POST" enctype="multipart/form-data">
                            <div class="mb-4">
                                <label for="user_password" class="form-label">Mật khẩu</label>
                                <input type="password" class="form-control form-control-alt" name="user_password" id="ps_user_group" placeholder="Nhập mật khẩu cho sinh viên!">
                            </div>
                            ...
                            <div class="mb-4">
                                <em>Vui lòng soạn người dùng theo đúng định dạng. <a href="./public/filemau/danhsachsv.xlsx">Tải về file mẫu Excel</a></em>
                            </div>
