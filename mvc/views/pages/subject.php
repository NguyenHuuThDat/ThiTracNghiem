    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <button type="button" class="btn btn-hero btn-primary" data-bs-toggle="modal" data-bs-target="#modal-add-subject" data-role="monhoc" data-action="create">
            ...
            <form action="#" id="search-form" onsubmit="return false;">
                <div class="mb-4">
                    <div class="input-group">
                        <input type="text" class="form-control form-control-alt" id="search-input" name="search-input" placeholder="Tìm kiếm môn học...">
            ...
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <form class="block-content fs-sm form-add-subject">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-alt" name="mamonhoc" id="mamonhoc" placeholder="Nhập mã môn học">
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">Tên môn học</label>
                        <input type="text" class="form-control form-control-alt" name="tenmonhoc" id="tenmonhoc" placeholder="Nhập tên môn học">
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">Số tín chỉ</label>
                        <input type="number" class="form-control form-control-alt" name="sotinchi" id="sotinchi" placeholder="Nhập số tín chỉ">
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control form-control-alt" name="sotiet_lt" id="sotiet_lt" placeholder="Nhập số tiết lý thuyết">
                            </div>

                            <div class="col-6">
                                <label for="" class="form-label">Số tiết thực hành</label>
                                <input type="number" class="form-control form-control-alt" name="sotiet_th" id="sotiet_th" placeholder="Nhập số tiết thực hành">
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="table-responsive">
                ...
                <div class="block block-rounded mb-3">
                    <div class="block-content pb-3">
                        <a data-role="chuong" data-action="create" class="fw-bold" data-bs-toggle="collapse" href="#collapseChapter" role="button" aria-expanded="false" aria-controls="collapseChapter" id="btn-add-chapter">
                        ...
                        <div class="collapse" id="collapseChapter">
                            <form method="post" class="mt-2 form-chapter">
                                <div class="row mb-1">
                                    <div class="col-8">
                                        <input type="text" class="form-control" name="name_chapter" id="name_chapter" placeholder="Nhập tên chương">
                                    </div>

                                    <div class="col-4">
                                        <input type="hidden" name="mamon_chuong" id="mamon_chuong">
                                        <input type="hidden" name="machuong" id="machuong">
                                        <button id="add-chapter" type="submit" class="btn btn-alt-primary">Tạo chương</button>
                                        <button id="edit-chapter" type="submit" class="btn btn-primary">Đổi tên</button>
