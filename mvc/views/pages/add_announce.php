            ...
            <form class="block block-rounded form-tao-de" novalidate="novalidate">
                ...
                <div class="block block-content">
                    <div class="form-floating mb-4">
                        <textarea class="form-control" id="name-exam" name="name-exam" style="height: 100px" placeholder="Nhập nội dung thông báo"></textarea>
                        ...
                        <div class="block block-rounded border">
                            <div class="block-header block-header-default">
                                ...
                                <div class="block-option">
                                    <select class="js-select2 form-select" id="nhom-hp" name="nhom-hp" style="width: 100%;" data-placeholder="Chọn nhóm học phần thông báo..."
