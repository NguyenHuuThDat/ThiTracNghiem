    ...
    <div class="content content-full">
        <div class="block block-rounded">
            <ul class="nav nav-tabs nav-tabs-alt align-items-center" role="tablist">
                <li class="nav-item">
                    <button class="nav-link active" id="bang-diem-tab" data-bs-toggle="tab" data-bs-target="#bang-diem" role="tab" aria-controls="bang-diem" aria-selected="true">Bảng điểm</button>
                </li>
            ...
            <div class="block-content tab-content">
                            ...
                            <div class="input-group">
                                <div class="col-md-6 d-flex gap-3">
                                    ...
                                    <ul class="dropdown-menu mt-1" aria-labelledby="dropdown-filter-group">
                                        <li>
                                            <a class="dropdown-item filtered-by-group active" href="javascript:void(0)" data-value="0">Tất cả</a>
                                        </li>
                ...
                <div class="tab-pane" id="thong-ke" role="tabpanel" aria-labelledby="thong-ke-tab" tabindex="0">
                    ...
                    <ul class="dropdown-menu mt-1" aria-labelledby="dropdown-filter-static">
                        <li>
                            <a class="dropdown-item filtered-by-static active" href="javascript:void(0)" data-id="0">Tất cả</a>
                        </li>
            ...
            <?php
                if ($data["Test"]["loaide"] == 0) {
                    echo '<h5 class="mb-3">NỘI DUNG</h5>
                        <a href="javasript:void(0)" class="text-primary fw-bold" data-bs-toggle="modal" data-bs-target="#modal-cau-hoi" data-id="' . $data["Test"]["made"] . '"><i class="fa fa-file me-2"></i>Xem chi tiết</a>';
                }
            ?>
        </div>
    </div>
