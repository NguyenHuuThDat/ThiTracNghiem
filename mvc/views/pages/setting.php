            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="block-content block-content-full">
                        <h2 class="content-heading">Cơ bản</h2>
                        <div class="row items-push">
                            ...
                            <div class="col-lg-6 offset-lg-1">
                                <div class="mb-4">
                                    <label class="form-label" for="install-db-name">Tiêu đề trang web</label>
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="install-db-host">Mô tả</label>
