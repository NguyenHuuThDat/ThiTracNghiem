            ...
            <form class="block block-rounded form-tao-de">
                    ...
                    <div class="block block-content">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="name-exam" name="name-exam" placeholder="Nhập tên đề kiểm tra">
                        </div>

                        <div class="row mb-4">
                            <label class="form-label" for="time-start">Thời gian bắt đầu</label>
                            <div class="col-xl-6">
                                <input type="text" class="js-flatpickr form-control" id="time-start" name="time-start" data-enable-time="true" data-time_24hr="true" placeholder="Từ">
                            </div>

                            <div class="col-xl-6">
                                <input type="text" class="js-flatpickr form-control" id="time-end" name="time-end" data-enable-time="true" data-time_24hr="true" placeholder="Đến">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control text-center" id="exam-time" name="exam-time" placeholder="00">
                            ...
                            <div class="block block-rounded border">
                                <div class="block-header block-header-default">
                                    ...
                                    <div class="block-option">
                                        <select class="js-select2 form-select" id="nhom-hp" name="nhom-hp" style="width: 100%;" data-placeholder="Chọn nhóm học phần giảng dạy..." <?php if($data["Action"] == "update") echo "disabled"?>>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="mb-4 show-chap">
                            ...
                            <select class="js-select2 form-select" id="chuong" name="chuong" style="width: 100%;" data-placeholder="Chọn nhiều chương..." multiple>
                            </select>
                        </div>
