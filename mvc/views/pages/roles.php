    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <button data-role="nhomquyen" data-action="create" type="button" class="btn btn-hero btn-primary" data-bs-toggle="modal" data-bs-target="#modal-add-role">
                    <i class="fa-regular fa-plus me-1"></i> Thêm mới</button>
            </div>
        </div>
                    ...
                    <!-- <form action="be_pages_ecom_orders.html" method="POST" onsubmit="return false;">
                        <div class="mb-4">
                            <div class="input-group">
                                <input type="text" class="form-control form-control-alt" id="one-ecom-orders-search" name="one-ecom-orders-search" placeholder="Tìm kiếm nhóm quyền..">
            ...
            <div class="modal-body pb-1">
                <form class="form_role">
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control form-control-alt" id="ten-nhom-quyen" name="ten-nhom-quyen" placeholder="VD: Giảng viên">
                    </div>
