...
class MailAuth extends DB {
    ...
    public function __construct() {
        ...
        $this->mail->setFrom('huudatnh178@gmail.com', 'HAU TEST');
    }
        ...
        try {
            ...
            $this->mail->Body = '<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
                ...
                <div style="border-bottom:1px solid #eee">
                    <a href="#" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">HAU TEST</a>
                </div>
                ...
                <p style="font-size:0.9em;">Regards,<br />HAU TEST</p>
