                ...
                if (response.length > 0) {
                    response.forEach((chapter, index) => {
                        html += `<tr>
                                    ...
                                    <td class="text-center col-action">
                                        <a data-role="chuong" data-action="update" class="btn btn-sm btn-alt-secondary chapter-edit" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit" data-id="${chapter["machuong"]}">
                                            <i class="fa fa-fw fa-pencil"></i>
                                        </a>
                                
                                        <a data-role="chuong" data-action="delete" class="btn btn-sm btn-alt-secondary chapter-delete" href="javascript:void(0)" data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete" data-id="${chapter["machuong"]}">
                                            <i class="fa fa-fw fa-times"></i>
                                        </a>
                                    </td>
                                </tr>`;
                        ...
                        html += `<tr>
                                    <td class="text-center fs-sm" colspan="3">
