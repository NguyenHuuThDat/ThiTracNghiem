                ...
                data.forEach(item => {
                    html += `<tr>
                                ...
                                <td class="text-center col-action">
                                    ...
                                    <button data-role="nhomquyen" data-action="delete" class="btn btn-sm btn-alt-secondary delete_roles" data-id="${item.manhomquyen}" data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete">
