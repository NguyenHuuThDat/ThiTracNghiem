                            ...
                            <div class="d-md-flex justify-content-md-between align-items-md-center">
                                <div class="p-1 p-md-3">
                                    ...
                                    <p class="fs-sm text-muted mb-2">
                                        <i class="fa fa-layer-group me-1"></i></i> Giao cho học phần 
                                        <strong data-bs-toggle="tooltip" data-bs-animation="true" data-bs-placement="top" title="${test.nhom}" style="cursor:pointer">${test.tenmonhoc} - Năm Học ${test.namhoc} - ${Number(test.namhoc) + 1} - Học Kỳ ${test.hocky}</strong>
                                    </p>
