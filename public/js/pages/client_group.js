    ...
    function showListGroup(groups) {
        ...
        if(groups.length == 0) {
            ...
            groups.forEach((group,index) => {
                let btn_hide = group.hienthi == 1 ? 
                    `<a class="dropdown-item btn-hide-group" data-id="${group.manhom}" href="javascript:void(0)"><i class="nav-main-link-icon si si-eye me-2 text-dark"></i> Ẩn nhóm</a>` 
                    : 
                            ...
                            <div class="block block-rounded h-100 mb-0">
                                <div class="block-header">
                                    ...
                                    <div class="block-options">
                                        <div class="dropdown">
                                            <button type="button" class="btn btn-alt-secondary dropdown-toggle module__dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="block-content bg-body-light text-center">
                                    ...
                                    <h5 class="text-muted mb-3" style="font-size:13px">NĂM HỌC ${group.namhoc} - ${Number(group.namhoc) + 1} - HỌC KỲ ${group.hocky}</h5>
                                ...
                                <div class="block-content block-content-full">
                                    <div class="row g-sm">
                                        <div class="col-12">
                                            <button class="btn w-100 btn-alt-secondary btn-view-group" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample" data-id="${group.manhom}" data-index="${index}">
