        ...
        questions.forEach((item, index) => {
            ...
            item.cautraloi.forEach((op, i) => {
                data +=             `<div class="col-6 mb-1">
                                        <p class="mb-1"><b>${String.fromCharCode(i + 65)}.</b> ${op.noidungtl}</p>
                                    </div>`;
            });
            ...
            data +=         `<div class="test-ans bg-primary rounded-bottom py-2 px-3 d-flex align-items-center">
            ...
            data += dadung != null && dadung.macautl == item.dapanchon ? 
                                ...
                                <span class="mx-2 text-white">Đáp án đúng: ${String.fromCharCode(item.cautraloi.indexOf(dadung) + 65)}</span>`;
            data +=         `</div>
                        </div>`;
        });
